...
Library.prototype._bindEvents = function() {
	...
	// $("#id_dataTableModal2").on(
	//   "click",
	//   $.proxy(this._dataTableModal2Handler, this)
	// );
...
Library.prototype._topDistAuthorBtnModalHandler = function() {
	this._getAuthors();
...
Library.prototype._getAuthors = function() {
	...
	for (i = 0; i < this.myDistinctArray.length; i++) {
		for (j = i + 1; j < this.myDistinctArray.length; j++) {
